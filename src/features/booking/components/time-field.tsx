          ...
          {open && (
            ...
            >
                  ...
                  {(["AM", "PM"] as const).map((m) => (
                    <button
                      ...
                      className={cn(
                        ...
                        ap === m ? "bg-brand text-white" : "text-muted-foreground hover:bg-muted",
                      )}
                    >
                      {m}
                    </button>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            active ? "bg-brand text-white" : "text-foreground hover:bg-brand/10",
                          )}
                        >
                          {n}
                        </button>
              ...
              <button
                ...
                className="mt-3 w-full rounded-xl bg-brand py-2 text-sm font-semibold text-white transition-colors hover:bg-brand/90"
              >
                Done
              </button>
            </motion.div>
